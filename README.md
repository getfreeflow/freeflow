...
**[getfreeflow.github.io/freeflow](https://getfreeflow.github.io/freeflow/)**
...
```bash
git clone https://github.com/getfreeflow/freeflow.git
```
...
```bash
git clone https://github.com/getfreeflow/freeflow.git && cd freeflow && xcodegen generate
```
